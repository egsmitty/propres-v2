...
const STEPS = [
  {
    ...
    body: 'Use Home for the quickest restart, Recent for a deeper history, and Open when you need to search your library by title or date.',
  },
  {
    id: 'templates',
    selector: '[data-tour="home-templates"]',
    title: 'Templates And Example Services',
    body: 'Home keeps your templates up top. Use More templates to open the full New screen, where Blank Presentation starts fresh, and Sunday Morning Example shows a complete service with announcements, worship, sermon content, media, and backgrounds already in place.',
  },
  {
    id: 'toolbar',
    selector: '[data-tour="editor-toolbar"]',
    title: 'Build The Flow',
    body: 'This row handles your fastest editing actions: add or duplicate slides, open the Song and Media libraries, add Announcement or Sermon sections, and jump into Present mode.',
  },
  {
    id: 'filmstrip',
    selector: '[data-tour="filmstrip"]',
    title: 'Service Order Stays Organized',
    body: 'Your service order stays grouped here by section. Songs, announcements, and sermons each keep their own slides, names, and running section background until you change sections.',
  },
  {
    id: 'canvas',
    selector: '[data-tour="canvas"]',
    title: 'Edit Text And Media',
    body: 'Double-click the active slide to edit text, then use the formatting bar for size, alignment, bold, and color. Media slides can also take over the output here without text on top.',
  },
  {
    id: 'present',
